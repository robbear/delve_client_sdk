...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.CSVFileSchemaAllOf();
  });
  ...
  describe('CSVFileSchemaAllOf', function() {
    it('should create an instance of CSVFileSchemaAllOf', function() {
      // uncomment below and update the code to test CSVFileSchemaAllOf
      //var instane = new RaiDbSdk.CSVFileSchemaAllOf();
      //expect(instance).to.be.a(RaiDbSdk.CSVFileSchemaAllOf);
    });
