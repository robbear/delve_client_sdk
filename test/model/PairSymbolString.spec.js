...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.PairSymbolString();
  });
  ...
  describe('PairSymbolString', function() {
    it('should create an instance of PairSymbolString', function() {
      // uncomment below and update the code to test PairSymbolString
      //var instane = new RaiDbSdk.PairSymbolString();
      //expect(instance).to.be.a(RaiDbSdk.PairSymbolString);
    });
