...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.ConsAllOf();
  });
  ...
  describe('ConsAllOf', function() {
    it('should create an instance of ConsAllOf', function() {
      // uncomment below and update the code to test ConsAllOf
      //var instane = new RaiDbSdk.ConsAllOf();
      //expect(instance).to.be.a(RaiDbSdk.ConsAllOf);
    });

    it('should have the property head (base name: "head")', function() {
      // uncomment below and update the code to test the property head
      //var instance = new RaiDbSdk.ConsAllOf();
