...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.SetOptionsActionAllOf();
  });
  ...
  describe('SetOptionsActionAllOf', function() {
    it('should create an instance of SetOptionsActionAllOf', function() {
      // uncomment below and update the code to test SetOptionsActionAllOf
      //var instane = new RaiDbSdk.SetOptionsActionAllOf();
      //expect(instance).to.be.a(RaiDbSdk.SetOptionsActionAllOf);
    });
