...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.ApplAllOf();
  });
  ...
  describe('ApplAllOf', function() {
    it('should create an instance of ApplAllOf', function() {
      // uncomment below and update the code to test ApplAllOf
      //var instane = new RaiDbSdk.ApplAllOf();
      //expect(instance).to.be.a(RaiDbSdk.ApplAllOf);
    });
    ...
    it('should have the property _arguments (base name: "arguments")', function() {
      ...
      //var instance = new RaiDbSdk.ApplAllOf();
