...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.Integration();
  });
  ...
  describe('Integration', function() {
    it('should create an instance of Integration', function() {
      ...
      //var instane = new RaiDbSdk.Integration();
      //expect(instance).to.be.a(RaiDbSdk.Integration);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new RaiDbSdk.Integration();
