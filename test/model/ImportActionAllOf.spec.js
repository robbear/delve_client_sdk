...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.ImportActionAllOf();
  });
  ...
  describe('ImportActionAllOf', function() {
    it('should create an instance of ImportActionAllOf', function() {
      // uncomment below and update the code to test ImportActionAllOf
      //var instane = new RaiDbSdk.ImportActionAllOf();
      //expect(instance).to.be.a(RaiDbSdk.ImportActionAllOf);
    });
