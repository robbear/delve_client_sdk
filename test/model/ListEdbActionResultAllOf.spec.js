...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.ListEdbActionResultAllOf();
  });
  ...
  describe('ListEdbActionResultAllOf', function() {
    it('should create an instance of ListEdbActionResultAllOf', function() {
      // uncomment below and update the code to test ListEdbActionResultAllOf
      //var instane = new RaiDbSdk.ListEdbActionResultAllOf();
      //expect(instance).to.be.a(RaiDbSdk.ListEdbActionResultAllOf);
    });
