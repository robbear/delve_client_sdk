...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.UpdateActionResult();
  });
  ...
  describe('UpdateActionResult', function() {
    it('should create an instance of UpdateActionResult', function() {
      // uncomment below and update the code to test UpdateActionResult
      //var instane = new RaiDbSdk.UpdateActionResult();
      //expect(instance).to.be.a(RaiDbSdk.UpdateActionResult);
    });
