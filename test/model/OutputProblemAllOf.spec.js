...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.OutputProblemAllOf();
  });
  ...
  describe('OutputProblemAllOf', function() {
    it('should create an instance of OutputProblemAllOf', function() {
      // uncomment below and update the code to test OutputProblemAllOf
      //var instane = new RaiDbSdk.OutputProblemAllOf();
      //expect(instance).to.be.a(RaiDbSdk.OutputProblemAllOf);
    });
    ...
    it('should have the property exception (base name: "exception")', function() {
      ...
      //var instance = new RaiDbSdk.OutputProblemAllOf();
