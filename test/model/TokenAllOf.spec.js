...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.TokenAllOf();
  });
  ...
  describe('TokenAllOf', function() {
    it('should create an instance of TokenAllOf', function() {
      // uncomment below and update the code to test TokenAllOf
      //var instane = new RaiDbSdk.TokenAllOf();
      //expect(instance).to.be.a(RaiDbSdk.TokenAllOf);
    });
