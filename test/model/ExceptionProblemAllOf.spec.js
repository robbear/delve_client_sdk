...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.ExceptionProblemAllOf();
  });
  ...
  describe('ExceptionProblemAllOf', function() {
    it('should create an instance of ExceptionProblemAllOf', function() {
      // uncomment below and update the code to test ExceptionProblemAllOf
      //var instane = new RaiDbSdk.ExceptionProblemAllOf();
      //expect(instance).to.be.a(RaiDbSdk.ExceptionProblemAllOf);
    });
    ...
    it('should have the property exception (base name: "exception")', function() {
      ...
      //var instance = new RaiDbSdk.ExceptionProblemAllOf();
