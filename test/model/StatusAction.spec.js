...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.StatusAction();
  });
  ...
  describe('StatusAction', function() {
    it('should create an instance of StatusAction', function() {
      ...
      //var instane = new RaiDbSdk.StatusAction();
      //expect(instance).to.be.a(RaiDbSdk.StatusAction);
    });

    it('should have the property dummy (base name: "dummy")', function() {
      // uncomment below and update the code to test the property dummy
      //var instance = new RaiDbSdk.StatusAction();
