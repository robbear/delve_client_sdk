...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.UpdateActionAllOf();
  });
  ...
  describe('UpdateActionAllOf', function() {
    it('should create an instance of UpdateActionAllOf', function() {
      // uncomment below and update the code to test UpdateActionAllOf
      //var instane = new RaiDbSdk.UpdateActionAllOf();
      //expect(instance).to.be.a(RaiDbSdk.UpdateActionAllOf);
    });
