...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.ListSourceActionResult();
  });
  ...
  describe('ListSourceActionResult', function() {
    it('should create an instance of ListSourceActionResult', function() {
      ...
      //var instane = new RaiDbSdk.ListSourceActionResult();
      //expect(instance).to.be.a(RaiDbSdk.ListSourceActionResult);
    });
    ...
    it('should have the property sources (base name: "sources")', function() {
      ...
      //var instance = new RaiDbSdk.ListSourceActionResult();
