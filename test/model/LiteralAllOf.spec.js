...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.LiteralAllOf();
  });
  ...
  describe('LiteralAllOf', function() {
    it('should create an instance of LiteralAllOf', function() {
      // uncomment below and update the code to test LiteralAllOf
      //var instane = new RaiDbSdk.LiteralAllOf();
      //expect(instance).to.be.a(RaiDbSdk.LiteralAllOf);
    });
