...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RaiDbSdk.CSVFileSyntaxAllOf();
  });
  ...
  describe('CSVFileSyntaxAllOf', function() {
    it('should create an instance of CSVFileSyntaxAllOf', function() {
      // uncomment below and update the code to test CSVFileSyntaxAllOf
      //var instane = new RaiDbSdk.CSVFileSyntaxAllOf();
      //expect(instance).to.be.a(RaiDbSdk.CSVFileSyntaxAllOf);
    });
    ...
    it('should have the property datarow (base name: "datarow")', function() {
      ...
      //var instance = new RaiDbSdk.CSVFileSyntaxAllOf();
